    ...
    <ul class="navbar-nav">
      @if (Auth::user()->role == 'Admin')
        ...
        <li class="nav-item pb-2">
          <a class="nav-link {{ (Request::is('santri-management') ? 'active' : '') }}" href="{{ url('santri-management') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('santri-management') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
              </div>
              <span class="nav-link-text ms-1">Data Santri</span>
          </a>
        </li>
        <li class="nav-item pb-2">
          <a class="nav-link {{ (Request::is('kegiatan-management') ? 'active' : '') }}" href="{{ url('kegiatan-management') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('kegiatan-management') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
              </div>
