      ...
      <li class="nav-item pb-2">
        ...
        <li class="nav-item pb-2">
          <a class="nav-link nav-link2 {{ (Request::is('kategori') ? 'active' : '') }}" href="{{ url('kategori') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i style="font-size: 1rem;" class="fa fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('kategori') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
              </div>
        ...
        <li class="nav-item pb-2">
          <a class="nav-link nav-link2 {{ (Request::is('list-berita') ? 'active' : '') }}" href="{{ url('list-berita') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i style="font-size: 1rem;" class="fa fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('list-berita') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
              </div>
        ...
        <li class="nav-item pb-2">
          <a class="nav-link nav-link2 {{ (Request::is('setting') ? 'active' : '') }}" href="{{ url('setting') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i style="font-size: 1rem;" class="fa fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('setting') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
              </div>
